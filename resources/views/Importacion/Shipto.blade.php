...
<main class="main" id="top">
    <div class="container-fluid" data-layout="container">
        <div class="content">
            ...
            <div class="card mb-3" id="customersTable" data-list='{"valueNames":["name","email","phone","address","joined"],"page":10,"pagination":true}'>
                ...
                <div class="table-responsive">
                    <table class="table table-sm table-striped fs--1 mb-0 overflow-hidden" id="tbl_shipto">
        ...
        <!--OPEN MODALS -->
        <div class="modal fade" id="modal_new_ship_to" tabindex="-1" role="dialog" aria-labelledby="authentication-modal-label" aria-hidden="true">
          <div class="modal-dialog modal-xl mt-6" role="document">
            <div class="modal-content border-0">
              ...
              <div class="mb-3">
                    <label class="fs-0" for="id_name_shipto">Nombre: </label>
                    <input class="form-control" id="id_name_shipto" type="text" name="name_shipto" required="required" />
                  </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                  <button class="btn btn-primary d-block w-100 mt-3" id="id_send_frm_shipto" type="submit" name="submit">Guardar</button>
                </div>
              </div>
            </div>
          </div>
