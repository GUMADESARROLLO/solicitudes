        ...
        @include('layouts.nav_gumadesk')
            ...
            <div class="card-header">
                ...
                <div class="col-4 col-sm-auto d-flex align-items-center pe-0">
                    <h5 class="fs-0 mb-0 text-nowrap py-2 py-xl-0">Unidades de Negocio</h5>
                </div>
                            ...
                            <?php
                                for ($i=1; $i <= 10; $i++) { 
                                    ...
                                    <td class="name align-middle white-space-nowrap py-2"><a href="../../app/e-commerce/customer-details.html">
                                        ...
                                        <div class="flex-1">
                                            <h5 class="mb-0 fs--1">'.$i.' .- Nombre Unidad de Negocio </h5>
                                        </div>
                                        </div>
                                    </a></td>
            ...
            <div class="modal-content border">
              <form id="addEventForm" autocomplete="off">
                <div class="modal-header px-card bg-light border-bottom-0">
                  <h5 class="modal-title">Crear Unidad de Negocio</h5>
